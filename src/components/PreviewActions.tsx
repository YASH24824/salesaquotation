  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-4 pb-2">
      <div className="mb-4 flex items-start gap-2 rounded-lg bg-blue-50 px-3 py-2.5 text-sm text-blue-700">
        ...
        <p>
          Found a mistake? Switch back to the quotation tab, make your
          changes and click <span className="font-semibold">Generate Quotation</span> again
          — this preview will update.
        </p>
      </div>
